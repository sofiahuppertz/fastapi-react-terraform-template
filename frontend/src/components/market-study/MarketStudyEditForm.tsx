...
interface MarketStudyEditFormProps {
  country: string;
  appStore: string;
  appId: string;
  appName: string;
...
export function MarketStudyEditForm({
  country,
  appStore,
  appId,
  appName,
    ...
    <div className="p-6">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          >
            Update your market study details
          </p>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div>
            ...
            >
              App Name <span style={{ color: semantic.danger }}>*</span>
            </label>
            <input
              type="text"
              id="edit-app-name"
          ...
          <div className="flex space-x-4 pt-4">
            <button
              type="submit"
              disabled={submitting || !appId.trim() || !appName.trim()}
              ...
              onMouseEnter={(e) => {
                if (!submitting && appId.trim() && appName.trim()) {
            ...
            >
              ...
              />
              <span>{submitting ? 'Updating...' : 'Update Market Study'}</span>
            </button>
            <button
              type="button"
              onClick={onCancel}
